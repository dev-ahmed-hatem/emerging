                        ...
                        <div className="w-full lg:w-1/2 order-2 lg:order-1">
                            ...
                            <div className="p-6 md:p-8 bg-white rounded-3xl shadow-xl border-t-4 border-[#2A807A] transition duration-500 hover:shadow-2xl">
                                ...
                                <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 border-b pb-4 border-gray-100">
                                    تأسست اللجنة التنسيقية لجمعيات تحفيظ القرآن بالمملكة بهدف توحيد الجهود، وتعظيم الأثر، ورفع مستوى الأداء للجمعيات الخيرية العاملة في ميدان خدمة القرآن الكريم. نعمل على تقديم الدعم اللوجستي، والاستشارات المتخصصة، والبرامج التدريبية التي تضمن تحقيق رؤية قرآنية شاملة.
                                </p>
