...
//       {
//         type: "paragraph",
//         text: "في إطار التوسع في دائرة التأثير، أعلن المجلس عن بدء مفاوضات مع كبرى الشركات الوطنية والدولية لعقد شراكات استراتيجية طويلة الأمد. هذه الشراكات لن تقتصر على الدعم المالي، بل تشمل تبادل الخبرات، وتقديم الخدمات  وتخصيص نسبة من المسؤولية المجتمعية لتنفيذ مشاريع نوعية ذات أثر مستدام.",
//       },
//       {
//         type: "quote",
...
//     author: "سليمان العتيبي",
//     authorBio:
//       "خبير استراتيجي في العمل الخيري ومتخصص في حوكمة المنظمات غير الربحية.",
//     tags: ["تدشين", "جمعيات", "رؤية 2030", "تنمية"],
//     content: [
//       {
//         type: "paragraph",
//         text: "في خطوة تاريخية نحو تعزيز الشراكة المجتمعية وتحقيق أهداف التنمية المستدامة...",
//       },
//     ],
//   },
//   {
//     id: 2,
//     title: "برعاية أمير حائل: 'مجلس الجمعيات الأهلية شريك تنموي'",
//     description: "برعاية كريمة، أقيم الملتقى التنسيقي الأول في حائل...",
//     date: "30 نوفمبر 2023",
//     imageUrl: "/news-02.jpg",
//     category: "أخبار اللجنة",
//     duration: "7 دقائق قراءة",
...
//       {
//         type: "paragraph",
//         text: "الملتقى التنسيقي الأول في حائل شهد إقبالاً كبيراً...",
//       },
//     ],
//   },
// ].sort((a, b) => new Date(b.date) - new Date(a.date));

// const sampleItem = allNewsItems[0]; // الخبر الافتراضي
...
// // ********************************************
// const SingleBlogPage = () => {
//   const item = sampleItem; // ✅ إصلاح الخطأ هنا
...
//                 "#",
//                 ""
//               )}/${TEXT_LIGHT.replace("#", "")}?text=صورة+الخبر`;
//             }}
//           />
//         </figure>
...
// // ألوان الهوية المعتمدة (لضمان التناسق)
// // ********************************************
// const PRIMARY_DARK = "#123da0";
// const PRIMARY_LIGHT = "#1e60e6";
// const ACCENT_COLOR = "#6de7fe";
// const BACKGROUND_DEEP = "#111827";
// const CARD_BACKGROUND = "#1f2937";
...
//       {
//         type: "paragraph",
//         text: "لطالما واجه القطاع غير الربحي تحديات تنظيمية ولوجستية...",
//       },
//       {
//         type: "quote",
//         text: "أكد معالي وزير الشؤون الاجتماعية أن: 'الاستدامة هي جوهر عملنا...'",
//       },
//     ],
//   },
//   {
...
//     id: 3,
//     title: "زيارة خاصة لسدارة الأعمال الاجتماعية",
//     description: "قام وفد من اللجنة بزيارة مركز سدارة لمناقشة آفاق التعاون...",
//     date: "30 نوفمبر 2023",
//     imageUrl: "/news-03.jpg",
//     category: "زيارات",
//     duration: "5 دقائق قراءة",
//     author: "فريق التحرير",
//     authorBio: "فريق متخصص في تغطية الزيارات الميدانية.",
//     tags: ["زيارات", "سدارة", "تعاون", "قرآن"],
//     content: [
//       {
//         type: "paragraph",
//         text: "زيارة وفد اللجنة لمركز سدارة كانت مثمرة...",
//       },
//     ],
//   },
// ].sort((a, b) => new Date(b.date) - new Date(a.date));

// const sampleItem = allNewsItems[0];
// const sampleItem2 = allNewsItems[1];
// const sampleItem3 = allNewsItems[2];
...
// // ----------------------------------------------------
// const SingleBlogPage = () => {
//   const item = sampleItem; // ✅ تم إصلاح الخطأ هنا
//   const item2 = sampleItem2; // ✅ تم إصلاح الخطأ هنا
//   const item3 = sampleItem3; // ✅ تم إصلاح الخطأ هنا
//   const navigate = useNavigate();
...
//           >
//             <div className="flex items-center">
//               <User size={20} className="ml-2" style={{ color: PRIMARY_LIGHT }} />
//               <span className="font-bold">{item.author}</span>
//             </div>
//             <div className="flex items-center">
//               <Calendar
...
//             </div>
//             <div className="flex items-center">
//               <Clock size={20} className="ml-2" style={{ color: PRIMARY_LIGHT }} />
//               <span>{item.duration}</span>
//             </div>
//             <div className="flex items-center ml-auto">
//               <Share2
...
//         <ArticleContent content={item.content} />
//         <ArticleContent content={item2.content} />
//         <ArticleContent content={item3.content} />
//         <AuthorBox author={item.author} authorBio={item.authorBio} />
//       </div>
...
const allNewsItems = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "quote",
        text: "وأكد سمو الأمير أهمية تطوير العمل المؤسسي واستدامة الشراكات.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "زيارة وفد اللجنة لمركز سدارة كانت مثمرة وأسفرت عن تعاون مبدئي في مجال الابتكار الاجتماعي...",
      },
      {
        type: "heading",
        text: "نتائج الزيارة",
      ...
      {
        type: "paragraph",
        text: "تم الاتفاق على عقد ورش عمل تدريبية مشتركة واستحداث لجنة متابعة للمشروعات المستقبلية.",
      },
    ],
  },
];
      ...
      switch (block.type) {
        ...
        case "heading":
          return (
            <h3
              key={i}
              className="text-3xl font-extrabold pt-8 pb-3 border-b-2 mt-10"
              style={{ color: TEXT_LIGHT, borderColor: PRIMARY_LIGHT + "70" }}
            >
              {block.text}
            </h3>
        ...
        case "quote":
          return (
            <blockquote
              key={i}
              className="border-r-8 border-l-2 p-6 italic text-xl font-light rounded-lg shadow-lg my-10"
              style={{
                borderRightColor: ACCENT_COLOR,
                borderLeftColor: PRIMARY_DARK,
                backgroundColor: CARD_BACKGROUND,
...
const AuthorBox = ({ author, authorBio }) => (
  <div
    className="mt-12 pt-8 border-t-2 border-dashed"
    style={{ borderColor: ACCENT_COLOR + "50" }}
  >
    <div
      className="p-6 md:p-8 rounded-2xl flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0"
...
// 🧩 الصفحة الرئيسية للمدونة (عرض كل الأخبار بمحتواها الكامل)
const SingleBlogPage = () => {
  const navigate = useNavigate();
  const onBack = () => navigate("/blogs");
    ...
    >
      ...
      <div className="container mx-auto max-w-5xl space-y-32">
        ...
        <div className="flex justify-between mb-8">
          <button
            onClick={onBack}
            className="flex items-center text-lg font-bold hover:opacity-80"
            style={{ color: ACCENT_COLOR }}
          >
            <ArrowRight size={20} className="ml-2" /> العودة إلى المدونة
          </button>
          <button
            onClick={onHome}
            className="flex items-center text-lg font-bold hover:opacity-80"
            style={{ color: ACCENT_COLOR }}
          >
            <ArrowRight size={20} className="ml-2" /> العودة إلى الرئيسية
          </button>
        </div>

        {/* عرض جميع الأخبار */}
        {allNewsItems.map((item) => (
          <article key={item.id} className="pb-24 border-b border-gray-700">
            <header className="mb-8">
              ...
              <div
                className="flex flex-wrap gap-x-6 gap-y-2 text-lg font-medium py-3 border-y border-gray-700"
                style={{ color: TEXT_HINT }}
              >
                <div className="flex items-center">
                  <User size={20} className="ml-2" style={{ color: PRIMARY_LIGHT }} />
                ...
                <div className="flex items-center">
                  <Calendar size={20} className="ml-2" style={{ color: PRIMARY_LIGHT }} />
                  <span>{item.date}</span>
                </div>
                <div className="flex items-center">
                  <Clock size={20} className="ml-2" style={{ color: PRIMARY_LIGHT }} />
