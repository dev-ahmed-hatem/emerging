...
const VISION_TEXT = "بيئة تنافسية للبنـــين والبنـــات لخدمة القرآن الكريم.";
const MISSION_TEXT = "تنظيـــم مســـابقة نوعية تتســـم بالجودة والمهنيـــة، تعزز التنافس الإيجابي وتطور آليـــات املشـــاركة والتحكيـــم لتحقيـــق الانتشار وفق أفضل المعايير.";
