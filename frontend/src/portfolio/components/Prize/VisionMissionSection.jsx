...
const VISION_TEXT = "بيئة تنافسية للبنـــين والبنـــات لخدمة القرآن الكريم.";
const MISSION_TEXT = "تنظيـــم مســـابقة نوعية تتســـم بالجودة والمهنية، تعزز التنافس الإيجابي وتطور آليـــات المشـــاركة والتحكيـــم لتحقيـــق الانتشار وفق أفضل المعايير.";
