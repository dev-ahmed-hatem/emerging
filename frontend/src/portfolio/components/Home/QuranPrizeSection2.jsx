            ...
            <div className="w-full">
              ...
              >
                ...
                <p className="text-neutral-700 leading-relaxed text-base md:text-lg mb-6">
                  ...
                  الكريـــم وتلاوتـــه وتجويده على مســـتوى المملكة. تســـتهدف
                  البنين والبنات ضمن المرحلة الدراســـية الابتدائيـــة
                  والتمهيديـــة والروضـــة، ويتنافـــس المتســـابقون
                  والمتســـابقات فيهـــا في ســـتة فـــروع محددة وتقدم لهم
                  الجوائز القيمة.
                </p>
