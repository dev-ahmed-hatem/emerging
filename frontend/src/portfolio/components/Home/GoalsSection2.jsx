...
const GoalsSection = () => {
    ...
    const strategicGoals = [
        ...
        'تبني وإطالق المبادرات المشتركة والبرامج االستراتيجية التي تخدم كافة جمعيات التحفيظ',
        'اإلسهام في معالجة التحديات والعوائق التي تواجه جمعيات التحفيظ لتحقيق رسالتها وأهدافها',
        'بناء الشراكات والعالقات النوعية لدعم جمعيات تحفيظ القرآن',
