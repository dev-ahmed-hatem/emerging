...
import ApplicantProfilePage from "@/admin/pages/applicants/ApplicantProfilePage";
import ApplicantForm from "@/admin/pages/applicants/ApplicantForm";
import ApplicantEdit from "@/admin/pages/applicants/ApplicantEdit";
